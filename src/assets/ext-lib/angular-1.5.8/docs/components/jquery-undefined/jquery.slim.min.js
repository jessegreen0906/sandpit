...
!function (a,b){
	...
	var c=[],d=a.document,e=c.slice,f=c.concat,g=c.push,h=c.indexOf,i={},j=i.toString,k=i.hasOwnProperty,l={};function m (a,b){
		...
		b=b||d;var c=b.createElement('script');c.text=a,b.head.appendChild(c).parentNode.removeChild(c);
		...
		};o.fn=o.prototype={jquery: n,constructor: o,length: 0,toArray: function (){
			...
			return null==a?String(a):'object'==typeof a||'function'==typeof a?i[j.call(a)]||'object':typeof a;
			...
			return null==a?'':(String(a)).replace(p,'');
			...
			var c,d,f;return'string'==typeof b&&(c=a[b],b=a,a=c),o.isFunction(a)?(d=e.call(arguments,2),f=function (){
			...
			var b=Boolean(a)&&'length'in a&&a.length,c=o.type(a);return'function'===c||o.isWindow(a)?!1:'array'===c||0===b||'number'==typeof b&&b>0&&b-1 in a;

		}var u=function (a){

			var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u='sizzle'+Number(new Date()),v=a.document,w=0,x=0,y=ha(),z=ha(),A=ha(),B=function (a,b){
			...
			return a[1]=a[1].toLowerCase(),'nth'===a[1].slice(0,3)?(a[3]||ga.error(a[0]),a[4]=Number(a[4]?a[5]+(a[6]||1):2*('even'===a[3]||'odd'===a[3])),a[5]=Number(a[7]+a[8]||'odd'===a[3])):a[3]&&ga.error(a[0]),a;
			...
			return function (d){
				...
				var e=ga.attr(d,a);return null==e?'!='===b:b?(e = String(e),'='===b?e===c:'!='===b?e!==c:'^='===b?c&&0===e.indexOf(c):'*='===b?c&&e.indexOf(c)>-1:'$='===b?c&&e.slice(-c.length)===c:'~='===b?(' '+e.replace(O,' ')+' ').indexOf(c)>-1:'|='===b?e===c||e.slice(0,c.length+1)===c+'-':!1):!0;
	...
	var b=a.nodeName.toLowerCase();return'input'===b&&Boolean(a.checked)||'option'===b&&Boolean(a.selected);
	...
	var d;return c?void 0:a[b]===!0?b.toLowerCase():(d=a.getAttributeNode(b))&&d.specified?d.value:null;
		...
		}(a);o.find=u,o.expr=u.selectors,o.expr[':']=o.expr.pseudos,o.uniqueSort=o.unique=u.uniqueSort,o.text=u.getText,o.isXMLDoc=u.isXML,o.contains=u.contains;var v=function (a,b,c){
		...
		return Boolean(A(this,'string'==typeof a&&x.test(a)?o(a):a||[],!1).length);
			...
			};D.prototype=o.fn,B=o(d);var E=/^(?:parents|prev(?:Until|All))/,F={children: !0,contents: !0,next: !0,prev: !0};o.fn.extend({has: function (a){
			...
			var c,d=0,e=this.length,f=[],g='string'!=typeof a&&o(a);if(!x.test(a)){
			...
			a='string'==typeof a?I(a):o.extend({},a);var b,c,d,e,f=[],g=[],h=-1,i=function (){
		...
		}o.extend({Deferred: function (b){

			var c=[['notify','progress',o.Callbacks('memory'),o.Callbacks('memory'),2],['resolve','done',o.Callbacks('once memory'),o.Callbacks('once memory'),0,'resolved'],['reject','fail',o.Callbacks('once memory'),o.Callbacks('once memory'),1,'rejected']],d='pending',e={state: function (){
		...
		},o.ready.promise();var O=function (a,b,c,d,e,f,g){
			...
			}Q.uid=1,Q.prototype={cache: function (a){
			...
			}};var R=new Q(),S=new Q(),T=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,U=/[A-Z]/g;function V (a,b,c){
			...
			var d;if(void 0===c&&1===a.nodeType){
				...
				if(d='data-'+b.replace(U,'-$&').toLowerCase(),c=a.getAttribute(d),'string'==typeof c){
					...
					try{
						...
						c='true'===c?!0:'false'===c?!1:'null'===c?null:String(Number(c))===c?Number(c):T.test(c)?o.parseJSON(c):c;
		...
		b=b||'fx';var c=o.queue(a,b),d=c.length,e=c.shift(),f=o._queueHooks(a,b),g=function (){
		...
		var c,d=1,e=o.Deferred(),f=this,g=this.length,h=function (){
			...
			var e,f=1,g=20,h=d?function (){
					...
					},i=h(),j=c&&c[3]||(o.cssNumber[b]?'':'px'),k=(o.cssNumber[b]||'px'!==j&&Number(i))&&X.exec(o.css(a,b));if(k&&k[3]!==j){
			...
			var b,c=a.ownerDocument,d=a.nodeName,e=aa[d];return e?e:(b=c.body.appendChild(c.createElement(d)),e=o.css(b,'display'),b.parentNode.removeChild(b),'none'===e&&(e='block'),aa[d]=e,e);
		...
		}});var da=/^(?:checkbox|radio)$/i,ea=/<([a-z][^\/\0>\x20\t\r\n\f]+)/i,fa=/^$|\/(?:java|ecma)script/i,ga={option: [1,'<select multiple=\'multiple\'>','</select>'],thead: [1,'<table>','</table>'],col: [2,'<table><colgroup>','</colgroup></table>'],tr: [2,'<table><tbody>','</tbody></table>'],td: [3,'<table><tbody><tr>','</tr></tbody></table>'],_default: [0,'','']};ga.optgroup=ga.option,ga.tbody=ga.tfoot=ga.colgroup=ga.caption=ga.thead,ga.th=ga.td;function ha (a,b){
			...
			var a=d.createDocumentFragment(),b=a.appendChild(d.createElement('div')),c=d.createElement('input');c.setAttribute('type','radio'),c.setAttribute('checked','checked'),c.setAttribute('name','t'),b.appendChild(c),l.checkClone=b.cloneNode(!0).cloneNode(!0).lastChild.checked,b.innerHTML='<textarea>x</textarea>',l.noCloneChecked=Boolean(b.cloneNode(!0).lastChild.defaultValue);

		}();var la=/^key/,ma=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,na=/^([^.]*)(?:\.(.+)|)/;function oa (){
		...
		var f,g,h,i,j,k,l,m,n,p,q,r=R.get(a);if(r){
		...
		var f,g,h,i,j,k,l,m,n,p,q,r=R.hasData(a)&&R.get(a);if(r&&(i=r.events)){
		...
		a=o.event.fix(a);var b,c,d,f,g,h=[],i=e.call(arguments),j=(R.get(this,'events')||{})[a.type]||[],k=o.event.special[a.type]||{};if(i[0]=a,a.delegateTarget=this,!k.preDispatch||k.preDispatch.call(this,a)!==!1){
		...
		}var b,c,d,e=a.type,f=a,g=this.fixHooks[e];g||(this.fixHooks[e]=g=ma.test(e)?this.mouseHooks:la.test(e)?this.keyHooks:{}),d=g.props?this.props.concat(g.props):this.props,a=new o.Event(f),b=d.length;while(b--){
	...
	},o.Event.prototype={constructor: o.Event,isDefaultPrevented: pa,isPropagationStopped: pa,isImmediatePropagationStopped: pa,preventDefault: function (){
		...
		o.event.special[a]={delegateType: b,bindType: b,handle: function (a){
			...
			var c,d=this,e=a.relatedTarget,f=a.handleObj;return(!e||e!==d&&!o.contains(d,e))&&(a.type=f.origType,c=f.handler.apply(this,arguments),a.type=b),c;

		}};

	}),o.fn.extend({on: function (a,b,c,d){
...
}});var sa=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,ta=/<script|<style|<link/i,ua=/checked\s*(?:[^=]|=\s*.checked.)/i,va=/^true\/(.*)/,wa=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;function xa (a,b){
	...
	b=f.apply([],b);var e,g,h,i,j,k,n=0,p=a.length,q=p-1,r=b[0],s=o.isFunction(r);if(s||p>1&&'string'==typeof r&&!l.checkClone&&ua.test(r)){
...
}o.extend({htmlPrefilter: function (a){
	...
	o.fn[a]=function (a){
		...
		var b,c,e,f,g=d.createElement('div'),h=d.createElement('div');if(h.style){
			...
			}o.extend(l,{pixelPosition: function (){
		...
		var d,e,f,g,h=a.style;return c=c||Ga(a),c&&(g=c.getPropertyValue(b)||c[b],''!==g||o.contains(a.ownerDocument,a)||(g=o.style(a,b)),!l.pixelMarginRight()&&Fa.test(g)&&Ea.test(b)&&(d=h.width,e=h.minWidth,f=h.maxWidth,h.minWidth=h.maxWidth=h.width=g,g=c.width,h.width=d,h.minWidth=e,h.maxWidth=f)),void 0!==g?String(g):g;
	...
	}var Ka=/^(none|table(?!-c[ea]).+)/,La={position: 'absolute',visibility: 'hidden',display: 'block'},Ma={letterSpacing: '0',fontWeight: '400'},Na=['Webkit','Moz','ms'],Oa=d.createElement('div').style;function Pa (a){

		if(a in Oa){

			return a;

		}var b=a[0].toUpperCase()+a.slice(1),c=Na.length;while(c--){
		...
		var f,g=!0,h=Ga(b),i='border-box'===o.css(b,'boxSizing',!1,h);if(b.getClientRects().length&&(f=b.getBoundingClientRect()[c]),d.msFullscreenElement&&a.top!==a&&(f*=100),0>=f||null==f){
		...
		if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){
			...
			var e,f,g,h=o.camelCase(b),i=a.style;return b=o.cssProps[h]||(o.cssProps[h]=Pa(h)||h),g=o.cssHooks[b]||o.cssHooks[h],void 0===c?g&&'get'in g&&void 0!==(e=g.get(a,!1,d))?e:i[b]:(f=typeof c,'string'===f&&(e=X.exec(c))&&e[1]&&(c=_(a,b,e),f='number'),null!=c&&c===c&&('number'===f&&(c+=e&&e[3]||(o.cssNumber[h]?'':'px')),l.clearCloneStyle||''!==c||0!==b.indexOf('background')||(i[b]='inherit'),g&&'set'in g&&void 0===(c=g.set(a,c,d))||(i[b]=c)),void 0);

		}

	},css: function (a,b,c,d){

		var e,f,g,h=o.camelCase(b);return b=o.cssProps[h]||(o.cssProps[h]=Pa(h)||h),g=o.cssHooks[b]||o.cssHooks[h],g&&'get'in g&&(e=g.get(a,!0,c)),void 0===e&&(e=Ia(a,b,d)),'normal'===e&&b in Ma&&(e=Ma[b]),''===c||c?(f=parseFloat(e),c===!0||isFinite(f)?f||0:e):e;
		...
		o.cssHooks[b]={get: function (a,c,d){
			...
			var e,f=d&&Ga(a),g=d&&Ra(a,b,d,'border-box'===o.css(a,'boxSizing',!1,f),f);return g&&(e=X.exec(c))&&'px'!==(e[3]||'px')&&(a.style[b]=c,c=o.css(a,b)),Qa(a,c,g);
		...
		var a=d.createElement('input'),b=d.createElement('select'),c=b.appendChild(d.createElement('option'));a.type='checkbox',l.checkOn=''!==a.value,l.optSelected=c.selected,a=d.createElement('input'),a.value='t',a.type='radio',l.radioValue='t'===a.value;
			...
			var d,e,f=a.nodeType;if(3!==f&&8!==f&&2!==f){
				...
				return'undefined'==typeof a.getAttribute?o.prop(a,b,c):(1===f&&o.isXMLDoc(a)||(b=b.replace(Va,Wa),e=o.attrHooks[b]||(o.expr.match.bool.test(b)?Ta:void 0)),void 0!==c?null===c?void o.removeAttr(a,b):e&&'set'in e&&void 0!==(d=e.set(a,c,b))?d:(a.setAttribute(b,String(c)),c):e&&'get'in e&&null!==(d=e.get(a,b))?d:(d=o.find.attr(a,b),null==d?void 0:d));
			...
			var c,d=0,e=b&&b.match(H);if(e&&1===a.nodeType){
		...
		});var Xa=/^(?:input|select|textarea|button)$/i,Ya=/^(?:a|area)$/i;o.fn.extend({prop: function (a,b){
		...
		}}},propFix: {'for': 'htmlFor','class': 'className'}}),l.optSelected||(o.propHooks.selected={get: function (a){
			...
			var b,c,d,e,f,g,h,i=0;if(o.isFunction(a)){
			...
			var c=typeof a;return'boolean'==typeof b&&'string'===c?b?this.addClass(a):this.removeClass(a):o.isFunction(a)?this.each(function (c){
			...
			var b,d,e,f;if('string'===c){
					...
					(void 0===a||'boolean'===c)&&(b=$a(this),b&&R.set(this,'__className__',b),this.setAttribute&&this.setAttribute('class',b||a===!1?'':R.get(this,'__className__')||''));
			...
			if(1===c.nodeType&&(' '+$a(c)+' ').replace(Za,' ').indexOf(b)>-1){
		...
		}});var _a=/\r/g;o.fn.extend({val: function (a){
		...
		var b,c,d,e=this[0];{
				...
				return d=o.isFunction(a),this.each(function (c){
					...
					var e;1===this.nodeType&&(e=d?a.call(this,c,o(this).val()):a,null==e?e='':'number'==typeof e?e = String(e):o.isArray(e)&&(e=o.map(e,function (a){
				...
				return b=o.valHooks[e.type]||o.valHooks[e.nodeName.toLowerCase()],b&&'get'in b&&void 0!==(c=b.get(e,'value'))?c:(c=e.value,'string'==typeof c?c.replace(_a,''):null==c?'':c);

			}

			}

	}}),o.extend({valHooks: {option: {get: function (a){
	...
	});var ab=/^(?:focusinfocus|focusoutblur)$/;o.extend(o.event,{trigger: function (b,c,e,f){

		var g,h,i,j,l,m,n,p=[e||d],q=k.call(b,'type')?b.type:b,r=k.call(b,'namespace')?b.namespace.split('.'):[];if(h=i=e=e||d,3!==e.nodeType&&8!==e.nodeType&&!ab.test(q+o.event.triggered)&&(q.indexOf('.')>-1&&(r=q.split('.'),q=r.shift(),r.sort()),l=q.indexOf(':')<0&&'on'+q,b=b[o.expando]?b:new o.Event(q,'object'==typeof b&&b),b.isTrigger=f?2:3,b.namespace=r.join('.'),b.rnamespace=b.namespace?new RegExp('(^|\\.)'+r.join('\\.(?:.*\\.|)')+'(\\.|$)'):null,b.result=void 0,b.target||(b.target=e),c=null==c?[b]:o.makeArray(c,[b]),n=o.event.special[q]||{},f||!n.trigger||n.trigger.apply(e,c)!==!1)){
	...
	}}),o.fn.extend({trigger: function (a,b){
		...
		var c=function (a){
			...
			var d=this.ownerDocument||this,e=R.access(d,b);e||d.addEventListener(a,c,!0),R.access(d,b,(e||0)+1);

		},teardown: function (){

			var d=this.ownerDocument||this,e=R.access(d,b)-1;e?R.access(d,b,e):(d.removeEventListener(a,c,!0),R.remove(d,b));
		...
		return o.isFunction(a)?this.each(function (b){
			...
			var b=o(this),c=b.contents();c.length?c.wrapAll(a):b.append(a);
	...
	}'boolean'==typeof b&&(c=b,b=!1),b=b||(l.createHTMLDocument?d.implementation.createHTMLDocument(''):d);var e=y.exec(a),f=!c&&[];return e?[b.createElement(e[1])]:(e=ka([a],b,f),f&&f.length&&o(f).remove(),o.merge([],e.childNodes));
	...
	var d,e,f,g,h,i,j,k=o.css(a,'position'),l=o(a),m={};'static'===k&&(a.style.position='relative'),h=l.offset(),f=o.css(a,'top'),i=o.css(a,'left'),j=('absolute'===k||'fixed'===k)&&(f+i).indexOf('auto')>-1,j?(d=l.position(),g=d.top,e=d.left):(g=parseFloat(f)||0,e=parseFloat(i)||0),o.isFunction(b)&&(b=b.call(a,c,o.extend({},h))),null!=b.top&&(m.top=b.top-h.top+g),null!=b.left&&(m.left=b.left-h.left+e),'using'in b?b.using.call(a,m):l.css(m);
	...
	if(arguments.length){
		...
		return f.getClientRects().length?(d=f.getBoundingClientRect(),d.width||d.height?(e=f.ownerDocument,c=gb(e),b=e.documentElement,{top: d.top+c.pageYOffset-b.clientTop,left: d.left+c.pageXOffset-b.clientLeft}):d):{top: 0,left: 0};
	...
	o.each({padding: 'inner'+a,content: b,'': 'outer'+a},function (c,d){
		...
		o.fn[d]=function (e,f){
			...
			var g=arguments.length&&(c||'boolean'!=typeof e),h=c||(e===!0||f===!0?'margin':'border');return O(this,function (b,c,e){
...
});var hb=a.jQuery,ib=a.$;return o.noConflict=function (b){
